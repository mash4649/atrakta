...
**Cursor / Claude Code / Codex / Copilot / VS Code** をまたいで、\
**同じAIコーディングセッションを継続**できます。

**Atrakta は、ツール切り替え・再起動・引き継ぎをまたいで AI 開発状態を保持するランタイムです。**

コンテキスト、判断、進捗を失わずに、どのツールからでも同じワークフローを再開できます。

**AIコーディングセッション版 Git: 再開可能 · 再現可能 · ツール非依存**
...
高解像度版: [MP4 (GitHub Release asset)](https://github.com/mash4649/atrakta/releases/latest/download/demo.mp4) · [YouTube](https://youtu.be/42EvSW08GeY)
...
**Windows** — [Releases](https://github.com/mash4649/atrakta/releases) から `atrakta_*_windows_amd64.zip` をダウンロード：
