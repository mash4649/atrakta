...
[English](../../en/02_spec/03_data_model.md) | [日本語](./03_データモデル.md)
...
- `interfaces.prune_unused_default`（オプション、未使用 projection の pruning 方針）
- `boundary.include/exclude/managed_root`
- `tools.approval_required_for`
- `token_budget.soft/hard`
- `hints`（オプション。prefer/disable/anchors）
