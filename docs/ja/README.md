...
- [成熟・普及ロードマップ](plan/maturity-roadmap.md)
- [Phase 1: `atrakta start` 設計](plan/phase1-start-command-design.md)
- [Phase 1: `atrakta start` Issueバックログ](plan/phase1-start-command-issues.md)
- [パッケージマネージャー公開](plan/package-manager-publishing.md)
...
- [ライセンス選定案（提案）](plan/license-options.md)
...
- [Plugin SDK インターフェース定義](architecture/plugin-sdk.md)
- [MCP サーバー統合](architecture/mcp-server.md)
- [監査の整合性と保持ポリシー](architecture/audit-integrity.md)
- [サーフェス移植性](architecture/surface-portability.md)
- [コミュニティテンプレート](community-templates.md)
